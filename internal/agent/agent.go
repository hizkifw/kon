...
`
	...
	prompt += "\n\nSubagents are available: run the executable above as `<kon> run \"<task>\"` in a background shell job; its final answer arrives when the job exits. Use them only when the user explicitly asks."
